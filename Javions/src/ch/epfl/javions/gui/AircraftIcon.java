...
/**
 * Le type énuméré AircraftIcon représente les différentes icônes d'aéronefs disponibles.
 */
public enum AircraftIcon {
     ...
     * Constructeur
     *
     * @param canRotate si l'aéronef doit être retourné
    ...
    /**
     * Méthode qui retourne l'icône correspondant le mieux à l'aéronef dont les caractéristiques sont celles
     * données qui ne peuvent pas être nulles.
     *
     * @param typeDesignator type de l'aéronef
     * @param typeDescription description d'un aéronef
     * @param category catégorie d'un aéronef
     * @param wakeTurbulenceCategory catégorie de turbulence d'un aéronef
     * @return l'icône correspondant le mieux à l'aéronef
     */
    ...
    /**
     * Méthode qui retourne vrai ssi l'icône peut (et doit) être tournée afin d'indiquer le cap de l'aéronef
     *
     * @return retourne vrai ssi l'icône peut (et doit) être tournée
     *         afin d'indiquer le cap de l'aéronef
     */
    ...
    /**
     * Méthode qui retourne le chemin SVG correspondant à l'icône
     *
